...
export enum BtcWalletErrorType {
  ConnectionCancelled = 'ConnectionCancelled',
}

export class BtcWalletError extends Error {
  private type: BtcWalletErrorType
  constructor(type: BtcWalletErrorType, message: string) {
    super(message)
    this.name = 'WalletError'
    this.type = type
  }

  public getType(): BtcWalletErrorType {
    return this.type
  }
}
